"""{display_name} recognizer wrapper over the shared Schema v1 engine."""
import os
from schema_v1_recognizer_engine import SchemaV1RecognizerEngine
from sets.{python_name}.runtime_metadata import load_runtime_metadata
...
ENGINE = None
SET_ID = {set_id_repr}
SET_CODE = {dataset_id_repr}
SET_NAME = {display_name_repr}
