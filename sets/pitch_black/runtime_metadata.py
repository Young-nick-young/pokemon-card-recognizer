"""Schema v1 runtime metadata for Pitch Black."""
...
EXPECTED_SET_ID = 'pitch-black'
EXPECTED_DISPLAY_CODE = 'PBL'
EXPECTED_DATASET_ID = 'me5'
LEGACY_CARD_ID_KEY = "legacyInventoryCardId"
CANONICAL_PREFIX = 'pbl-'
LEGACY_PREFIX = 'PBL-'
...
def load_runtime_metadata(package_directory=DEFAULT_PACKAGE_DIRECTORY):
    ...
    expected_numbers = list(range(1, 120 + 1))
    if list(cards_by_number) != expected_numbers:
        raise RuntimeError("Schema v1 runtime metadata must remain ordered collector numbers 1 through 120.")
