"""Read-only public projection of the Perfect Order Schema v1 package."""
...
def build_public_package(package_directory=PACKAGE_DIRECTORY):
    ...
    if package.set_id != EXPECTED_SET_ID:
        raise SchemaV1ValidationError(
            package_directory,
            [
                "manifest.setId: expected " + repr(EXPECTED_SET_ID)
    ...
    return {
        ...
        "variants": [
            {"variantId": variant["variantId"], "label": variant["label"]}
